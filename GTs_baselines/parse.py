...
def parse_method(args, n, c, d, device):
    if args.model == "GPS":
        ...
        gnn = GCN(in_channels=d,
                    ...
                    dropout=args.dropout)
        model = SGFormer(d, args.hidden_channels, c, num_layers=args.layers, alpha=args.alpha_sg, dropout=args.dropout,
...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--model', type=str, default='GPS', choices=['MPNN', 'GPS'])
    # GNN
