...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='link', help='Mag, Sig, QuaNet, '
    ...
    parser.add_argument('--NotImproved', type=int, default=2, help='consecutively Not Improved, break, 500, 450, 410, 210, 60')
