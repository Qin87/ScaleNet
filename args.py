...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='AiGib', help='GAT, RAT, UAT, DAT,GATv2,  RiGib, AiGib, UiGib, DATib')
    parser.add_argument('--v2', type=int, default=1, help='whether attention is GATv2, 1 means GATv2')
