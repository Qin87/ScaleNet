...
for Didataset in "${Direct_dataset[@]}"; do
    for layer in $layer_values; do
        ...
        #for fea  in $fea_deg; do
        for net in $net_values; do
            log_output="${Didataset//\//_}_${timestamp}_${net}_layer${layer}q${q_value}.log"

            # Run the Python script with parameters and log output
            python3 main.py   --net="$net"   --degfea=1  --layer=$((1 * layer))  --to_undirected=0   --to_reverse_edge=0  --use_best_hyperparams=1  --gcn_norm=1  \
