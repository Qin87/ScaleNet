...
for Didataset in "${Direct_dataset[@]}"; do
    for layer in $layer_values; do
        ...
        for net in $net_values; do
            ...
            python3 main.py   --net="$net"  --coef_agg="$layer"  --num_split=10  --inci_norm='dir' \
             --normalize=0 --all1=0   --to_undirected=0   --to_reverse_edge=0  --use_best_hyperparams=1  --gcn_norm=1  \
