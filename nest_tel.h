...
net_values="  GCN "
layer_values=" 15 16 17 18 19 20 30 40 50 60 70 100 300 400 500 600 1000 2000  "
...
for Didataset in "${Direct_dataset[@]}"; do
    for layer in $layer_values; do
        ...
        for net in $net_values; do
            ...
            python3 main.py  --net="$net"  --layer="$layer" --to_reverse_edge=0 --use_best_hyperparams=1   --Dataset='WikipediaNetwork/squirrel'  --add_selfloop=1  --to_undirected=0
