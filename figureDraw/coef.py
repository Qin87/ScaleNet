...
if norm is None:
    ...
    times = [8000, 800, 400, 200, 100, 10, 8, 5, 4, 3, 2, 1, 0.5, 0.05, 0.005, 5e-5, 5e-6]
    accuracy = [30.48, 32.24, 34.65, 36.2, 59.2, 72.15, 69.3, 75.9, 74.78, 75.2, 74.6, 71.27, 74, 68.4, 36.62, 25.22, 25.22]
