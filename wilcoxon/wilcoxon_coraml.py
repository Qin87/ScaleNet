...
_1iGu2 = np.array([82.89, 82.17, 78.77, 83.52, 83.91, 81.61, 81.06, 83.91, 81.02, 84.42, 83.61, 81.78, 80.55, 81.95, 84.08, 83.06, 80.93, 81.36, 80.72, 84.33, 84.16, 83.01, 81.66, 82.34, 84.84, 81.57, 80.68, 84.46, 81.32, 83.14])
_1iG = np.array([83.14, 78.81, 80.21, 81.44, 83.78, 81.83, 82.12, 81.44, 80.81, 84.08, 83.35, 82.17, 80.93, 81.19, 82.25, 81.78, 81.57, 81.95, 80.25, 84.03, 83.52, 79.02, 82.21, 81.87, 82.42, 81.91, 81.15, 81.06, 82.34, 82.93])
...
_1ym=np.array([81.32, 81.15, 80.08, 78.39, 80.38, 79.28, 81.44, 83.91, 79.62, 81.95, 80.04, 79.36, 80.51, 82.34, 82.17, 79.87, 82.04, 81.53, 80.13, 82.21, 80.17, 80.85, 79.32, 79.70, 82.00, 79.32, 79.36, 83.01, 80.98, 84.59])

models = [Scale,_1iGu2, _1iG, Sym, _1ym]
model_names = ['Scale', '_1iGu2', '_1iG', 'Sym', '_1ym']
