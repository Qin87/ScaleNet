...
def parse_args():
    ...
    parser.add_argument("--inci_norm", type=str, choices=["dir", "sym", 'row', 0, '0'], default="row")
    ...
    parser.add_argument('--Dataset', type=str, default='fb100/penn94', help=
    ...
    parser.add_argument('--NotImproved', type=int, default=100, help='consecutively Not Improved, break, 500, 450, 410, 210, 60')
    ...
    parser.add_argument("--structure", type=float, default=0,
                        help="1 pure structure, 0 pure feature, 0.5 structure is feature too")
